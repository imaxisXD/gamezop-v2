...
export default async function NewlyAddedLoading() {
    return (
        ...
        relative backdrop-blur-lg border-2 border-slate-400/10 flex flex-col justify-center items-center text-left rounded-md bg-opacity-40 h-fit bg-newly-gradient drop-shadow-md py-5
