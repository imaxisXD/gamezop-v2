    ...
    return (
        <Suspense fallback={<TrendingGamesLoading />}>
            <div className="max-w-5xl grid gap-4 xs:grid-cols-2 xs:p-8 md:grid-cols-4 lg:gap-6">
                <h1 className="text-4xl font-semibold  text-pink-500 xs:col-span-2 xs:grid xs:gap-4 xs:grid-cols-2 md:col-span-3 md:text-5xl md:grid-cols-3 lg:text-[2.9rem]">
                    <span className="md:col-span-2">Trending Games</span>
                </h1>
                <p className="xs:row-start-2 xs:col-start-2 xs:self-center md:col-start-1 md:col-span-2 md:pr-12 md:text-lg hidden md:block">
                </p>
